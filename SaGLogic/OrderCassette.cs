        ...
        public bool Add(OrderCassetteM log, out int newCassetteSeq)
        {
            ...
            if (!string.IsNullOrEmpty(log.OrdNo))
            {
                ...
                try
                {
                    ...
                    row["cassette_F1"] = log.CassetteF1;
                    row["cassette_F2"] = log.CassetteF2;
                    row["cassette_F3"] = log.CassetteF3;
                    row["cassette_F4"] = log.CassetteF4;
                    row["cassette_F5"] = log.CassetteF5;
                    row["cassette_F6"] = log.CassetteF6;
                    row["cassette_F7"] = log.CassetteF7;
                    row["cassette_F8"] = log.CassetteF8;
                    row["cassette_F9"] = log.CassetteF9;
                    row["cassette_F10"] = log.CassetteF10;
                    row["cassette_F11"] = log.CassetteF11;
                    row["cassette_F12"] = log.CassetteF12;
                    row["cassette_F13"] = log.CassetteF13;
                    row["cassette_F14"] = log.CassetteF14;
                    row["cassette_F15"] = log.CassetteF15;
                    row["cassette_F16"] = log.CassetteF16;
                    row["cassette_F17"] = log.CassetteF17;
                    row["cassette_F18"] = log.CassetteF18;
                    row["cassette_F19"] = log.CassetteF19;
                    row["cassette_F20"] = log.CassetteF20;
